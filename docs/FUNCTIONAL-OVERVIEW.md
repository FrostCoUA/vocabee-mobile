...
| Функція | Короткий опис | Стан | Док |
|---|---|---|---|
| Вибір тем (setup-екран) | Мультивибір словників із чекбоксами; «Вибрано: K тем · M слів». | [ЗАРАЗ] | [01](01-screens.md) §8, [11](11-practice-training.md) §7 |
| Колода флеш-карток | До 10 карток за раунд; flip-анімація по осі Y. | [ЗАРАЗ] | [01](01-screens.md) §8 |
| Бінарна оцінка «Знаю / Не знаю» | 2 кнопки; «Не знаю» перевертає картку + «Далі»; «Знаю» — одразу далі. | [ЗАРАЗ] | [11](11-practice-training.md) §1, §6 |
...
| «Запросити друзів» / реферал | Мертвий рядок профілю; може зв'язатися з промо-бонусом. | [ЗАРАЗ] мертве / [МАЙБУТНЄ] | [15](15-profile-and-settings.md) §5 |
...
| Міграції БД | `0001–0012` наявні; майбутня `0013_training_fields.sql` для D10 ще [НОВЕ] і не створена. | [ЗАРАЗ]/[НОВЕ] | [17](17-api-and-data-reference.md) §3.3 |
...
| N11 | Гібрид-тренування (пріоритет+Leitner+анти-повтор) + поля знань + майбутня `0013_training_fields.sql` **[НОВЕ, ще не створена]** + Room v5 | D10 | [11](11-practice-training.md) |
