...
| Виявлення дубліката | Живий локальний `Set` ключів пари (слово, переклад) → двобічний toggle `+`↔`✓` (`alreadyAdded` обчислюється, але споживача в UI не має). | [ЗАРАЗ] | [13](13-add-word-and-ai-search.md) §6 |
