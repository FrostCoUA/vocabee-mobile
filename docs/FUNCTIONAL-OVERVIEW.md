...
| Функція | Короткий опис | Стан | Док |
|---|---|---|---|
| Додавання слова текстом | Поле вводу доку словника з дебаунсом ≈700ms → `/search`. *(Другий дебаунс 1000ms належав видаленому оверлею.)* | [ЗАРАЗ] | [13](13-add-word-and-ai-search.md) §2 |
...
| ~~Морф додавання слова~~ | Морф-оверлей із пігулки (tween ~420ms) жив у видаленому `AddWordOverlay`; у доку деталей його немає. Лишається в motion-брифі як історія дизайну. | [ЗАРАЗ→змінено фазами 2–4] | [12](12-motion-and-interaction-brief.md) §F |
