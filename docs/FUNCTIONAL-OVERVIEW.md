...
| Колода флеш-карток | До 10 карток; active/done fullscreen без таб-бару; велика flip-картка з sense-контекстом і окремим TTS; вихід через confirmation sheet. | [ЗАРАЗ] | [01](01-screens.md) §8 |
| Бінарна оцінка «Знаю / Не знаю» | Тап картки лише flip; «Не знаю» показує відповідь + «Далі» (стрілка праворуч); «Знаю» — одразу далі. | [ЗАРАЗ] | [11](11-practice-training.md) §1, §6 |
