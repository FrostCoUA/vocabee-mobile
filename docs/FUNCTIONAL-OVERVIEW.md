...
| Виявлення дубліката | Живий локальний `Set` ключів пари (слово, переклад) → двобічний toggle `+`↔`✓` (`alreadyAdded` — лише підпис «додано раніше»). | [ЗАРАЗ] | [13](13-add-word-and-ai-search.md) §6 |
