...
історію подій та чинні ingest-ключі збережено. Окремий дашборд у налаштуванні:
...
На момент запису один графік має помилку SQL через незаквотовані кириличні
псевдоніми колонок; решта початкових графіків потребують перевірки запитів.
Не використовувати цей дашборд як джерело висновків до виправлення й повторної
перевірки кожного збереженого запиту.
