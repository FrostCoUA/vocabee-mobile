...
- **Кнопки відповіді / стани кнопок.**
  ...
  - Після «Не знаю»: одна кнопка «Далі» (`moveNext`), стрілка стоїть праворуч від напису.
