...
(function () {
  ...
  RD.sec({ x: 80, y: 60, num: '0', text: 'Vocabee · редизайн імплементації', sub: 'Проаналізовано Compose-код (App.kt, PrototypeDesignSystem.kt, PrototypeBottomSheets.kt, AddWordOverlay.kt). Нижче — перемальовані екрани як є в апці + доопрацювання, світла і темна теми, специфікація топ-бару і ботом-шитів.' });
  ...
  RD.board({
    ...
    body:
      ...
      '<li>Practice: вибір словників перед раундом, рівень засвоєння 0–100%</li>' +
      '<li>Шити: create / language / delete / need-bees / auth / sync-conflict / exit</li>' +
  ...
  /* ================= SECTION 1 — Головна ================= */
  RD.sec({ x: 80, y: 1120, num: '1', text: 'Головна · Словники', sub: 'Сітка 2×N, банер-слот під заголовком (гість / гаманець / критичний), свайп-видалення картки, FAB. Фон уніфіковано: Background, не білий. Заливка зліва на картці — % засвоєння слів словника.' });
  ...
  RD.frame({
    ...
    body: '<div style="display:flex;flex-direction:column;height:100%">' +
      ...
      '<div style="margin-top:18px;font-size:21px;font-weight:800;color:var(--ink)">Ще немає слів</div>' +
      '<div style="margin-top:9px;font-size:15px;line-height:23px;font-weight:500;color:var(--muted);max-width:280px">Введи або продиктуй слово в полі нижче, а варіанти перекладу підкаже AI.</div>' +
      '<div style="margin-top:14px;transform:rotate(90deg)">' + ic('arrowR', 34, 'color-mix(in srgb,' + A.teal + ' 72%, transparent)', 2.2) + '</div></div></div>' +
