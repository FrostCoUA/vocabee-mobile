...
data class WordDetails(
     ...
     *
     * **Best-effort ПІДКАЗКА, не джерело правди.** Сервер під час синку може
     * замінити `metadata.details` канонічною проєкцією linked-рядка — тоді цей
     * список зникає. Авторитетне джерело «близьких» у словнику — локальне
     * групування збережених записів (`groupBySense`); підказка лише доповнює
     * його, поки в словнику збережений один переклад сенсу.
     */
